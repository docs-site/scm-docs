...
在笔记《LV16-10-存储器系统-01-CortexM3》中我们详细了解看了位带操作，我们知道在Cortex-M3的SRAM和外设存储区会有位带别名(alias)区和位带区，而STM32是基于Cortex-M3内核的，具体的存储器映射是由芯片厂家进行设置，但是也都是遵循Cotex-M3的映射方式，我们来看一下[STM32中文参考手册](https://www.stmcu.com.cn/Designresource/detail/localization_document /710001)的2.3.2 位段一节：
